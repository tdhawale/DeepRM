...
class PGLearner:
    def __init__(self, pa):
        ...
        self._su_train_fn = theano.function([states, su_target], [su_loss, prob_act], updates=su_updates, allow_input_downcast=True)

        self._su_loss = theano.function([states, su_target], [su_loss, prob_act], allow_input_downcast=True)

        self._debug = theano.function([states], [states.flatten(2)], allow_input_downcast=True)
